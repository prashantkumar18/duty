...
const journey = [
  ...
  {
    period: "2019 — 2021",
    company: "SelfDrvn Enterprise",
    role: "Customer Success Director & VP Sales",
    place: "APAC",
    note: "Geo expansion across APAC. Built and led 10-person customer success team; designed CS SOPs and engagement frameworks.",
  },
  {
    period: "2016 — 2019",
    company: "CBLD · TalentGuard",
    role: "Head of Technology",
    place: "Singapore · ASEAN",
    note: "Led technology and customer success across the CBLD–TalentGuard partnership in APAC.",
  },
  {
    period: "2011 — 2015",
    company: "Advante 360",
